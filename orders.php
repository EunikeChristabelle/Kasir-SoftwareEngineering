                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        < <!-- <span class="float:right"><a
                                class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)"
                                id="new_order">
                        ...
                        <table class="table table-condensed table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p> <b><?php echo $row['amount_tendered'] > 0 ? $row['ref_no'] : 'N/A' ?></b>
                                        </p>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <p class="text-right">
                                            <b><?php echo number_format($row['total_amount'],2) ?></b>
                                        </p>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-outline-primary " type="button"
                                            onclick="location.href='kasir/index.php?id=<?php echo $row['id'] ?>'"
                                        ...
                                        <button class="btn btn-sm btn-outline-danger delete_order" type="button"
